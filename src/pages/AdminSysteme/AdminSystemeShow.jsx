      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <div className="d-flex gap-2">
          <Button 
            variant="primary" 
            as={Link} 
            to={`/admin-systeme/edit/admin-systeme/${id}`}
          >
              ...
              <div className="row">
                <div className="col-md-6 mb-3">
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <div className="fw-bold">Gestion des compte utilisateur</div>
                ...
                <div className="col-md-6 mb-3">
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <div className="fw-bold">Gestion des statistiques</div>
                      <small className="text-muted">Visualisation des statitiques de la plateforme</small>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <Card.Body>
              ...
              <div className="small">
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <Badge bg="info">Administrateur (Rôle 3)</Badge>
                </div>
              </div>
            </Card.Body>
          </Card>
      ...
      >
        ...
        <Modal.Body className={theme === "dark" ? "bg-dark text-light" : ""}>
          ...
          <div className="alert alert-warning">
            ...
            Cette action est irréversible. L'administrateur "{user.name}" sera définitivement supprimé du système.
          </div>
        </Modal.Body>
