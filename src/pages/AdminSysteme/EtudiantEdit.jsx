...
export default function EtudiantEdit() {
    ...
    const fetchData = async () => {
      try {
        ...
        const [userResponse, classroomResponse] = await Promise.all([
          api.get(`/admin-systeme/edit/etudiant/${id}`),
          api.get('/admin-systeme/view/etudiant') // Pour récupérer les classes
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post(`/admin-systeme/update/etudiant/${id}`, formDataToSend, {
        headers: {
      ...
      if (response.data.status === 'success') {
        ...
        setTimeout(() => {
          navigate(`/admin-systeme/show/etudiant/${id}`);
        }, 2000);
      }
    } catch (err) {
  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      ...
      const response = await api.put(`/admin-systeme/update/etudiant/${id}`, passwordData);
    ...
    return (
      <AdminSystemeLayout>
        ...
        <div className="d-flex gap-2">
          <Button variant="secondary" as={Link} to="/admin-systeme/view/etudiants">
        ...
        <div>
          <div className="d-flex align-items-center mb-2">
            <Button 
              ...
              size="sm"
              as={Link} 
              to={`/admin-systeme/show/etudiant/${id}`}
              className="me-3"
            >
              ...
              <Card.Body>
                <div className="d-grid gap-2">
                  ...
                  <Button
                    ...
                    as={Link}
                    to="/admin-systeme/view/etudiants"
                  >
