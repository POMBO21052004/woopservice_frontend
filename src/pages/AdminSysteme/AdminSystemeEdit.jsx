...
export default function EditAdminSysteme() {
  ...
  // Charger les données de l'administrateur systeme
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const response = await api.get(`/admin-systeme/edit/admin-systeme/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post(`/admin-systeme/update/admin-systeme/${id}`, formDataToSend, {
        headers: {
      ...
      if (response.data.status === 'success') {
        showToastMessage('Formateur mis à jour avec succès !', 'success');
        
        // Rediriger après 2 secondes
        setTimeout(() => {
          navigate(`/admin-systeme/show/admin-systeme/${id}`);
        }, 2000);
      }
    } catch (err) {
  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      ...
      const response = await api.put(`/admin-systeme/update/admin-systeme/${id}`, passwordData);
    ...
    return (
      <AdminSystemeLayout>
        ...
        <div className="d-flex gap-2">
          <Button variant="secondary" as={Link} to="/admin-systeme/view/admin-systeme">
        ...
        <div>
          <div className="d-flex align-items-center mb-2">
            <Button 
              ...
              size="sm"
              as={Link} 
              to={`/admin-systeme/show/admin-systeme/${id}`}
              className="me-3"
            >
              <i data-feather="arrow-left" className="me-1" style={{ width: '16px', height: '16px' }} />
              Retour
            </Button>
            <h1 className="h3 mb-0">Modifier l'administrateur systeme</h1>
          </div>
          <p className="text-muted mb-0">
            Modification des informations de l'administrateur systeme
          </p>
        </div>
      </div>
      ...
      <Form onSubmit={handleSubmit}>
        <Row>
                  ...
                  <Col md={6} className="mb-3">
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        placeholder="Nom complet de l'administrateur systeme"
                  ...
                  <Col md={6} className="mb-3">
                    <Form.Group>
                      ...
                      <Form.Text className="text-muted">
                        Numéro de contact de l'administrateur systeme
                      </Form.Text>
                    </Form.Group>
                  </Col>
                </Row>
          ...
          <Col lg={4}>
            ...
            {/* Informations sur l'administrateur systeme */}
            {user && (
              <Card className={`border-0 shadow-sm mb-4 ${theme === "dark" ? "bg-dark" : "bg-white"}`}>
                <Card.Header className={`border-0 ${theme === "dark" ? "bg-dark" : "bg-white"}`}>
                  <h5 className="mb-0 d-flex align-items-center">
                ...
                <Card.Body>
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <span className="badge bg-info">Administrateur</span>
                  </div>
                  <div className="d-flex align-items-center justify-content-between mb-2">
              ...
              <Card.Body>
                <div className="d-grid gap-2">
                  ...
                  <Button
                    ...
                    as={Link}
                    to="/admin-systeme/view/admin-systeme"
                  >
