...
export default function EditFormateur() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const response = await api.get(`/admin-systeme/edit/formateur/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post(`/admin-systeme/update/formateur/${id}`, formDataToSend, {
        headers: {
      ...
      if (response.data.status === 'success') {
        ...
        setTimeout(() => {
          navigate(`/admin-systeme/show/formateur/${id}`);
        }, 2000);
      }
    } catch (err) {
  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      ...
      const response = await api.put(`/admin-systeme/update/formateur/${id}`, passwordData);
        ...
        <div>
          <div className="d-flex align-items-center mb-2">
            <Button 
              ...
              size="sm"
              as={Link} 
              to={`/admin-systeme/show/formateur/${id}`}
              className="me-3"
            >
              ...
              <Card className={`border-0 shadow-sm mb-4 ${theme === "dark" ? "bg-dark" : "bg-white"}`}>
                ...
                <Card.Body>
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <span className="badge bg-info">Formateur</span>
                  </div>
                  <div className="d-flex align-items-center justify-content-between mb-2">
