...
export default function Formateur() {
  ...
  const fetchUsers = useCallback(async () => {
    try {
      ...
      const res = await api.get("/admin-systeme/view/formateur", { params });
  ...
  const handleSubmit = async (e) => {
    ...
    setErrors({});
    try {
      await api.post("/admin-systeme/store/formateur", form);
      fetchUsers();
  ...
  const handleDeleteConfirmed = async () => {
    try {
      ...
      if (userToDelete) {
        ...
        await api.delete(`/admin-systeme/destroy/formateur/${userToDelete}`);
      } else {
        // Suppression en lot
        await api.post(`/admin-systeme/destroy-group/formateur`, { ids: idsToDelete });
      }
  ...
  const handleDownloadPdf = async (e) => {
    ...
    try {
      ...
      const res = await api.get(`/admin-systeme/download/liste/formateur/pdf?${params.toString()}`, {
        responseType: "blob",
      });
  ...
  const handleDownloadExcel = async (e) => {
    ...
    try {
      ...
      const res = await api.get(`/admin-systeme/download/liste/formateur/excel?${params.toString()}`, {
        responseType: "blob",
      });
  ...
  return (
    <AdminSystemeLayout>
      <Container className="py-4">
                        ...
                        <td className="text-center">
                          <div className="d-flex gap-1 justify-content-center">
                            <Button
                              ...
                              as={Link}
                              to={`/admin-systeme/show/formateur/${user.id}`}
                            >
                            ...
                            <Button
                              ...
                              title="Modifier"
                              as={Link}
                              to={`/admin-systeme/edit/formateur/${user.id}`}
                            >
                      ...
                      <td colSpan="6" className="text-center py-5">
                        <div className={`${theme === "dark" ? "text-light" : "text-muted"}`}>
                          ...
                          <div>
                            ...
                            <p className="small mb-0">Aucun formateur ne correspond à vos critères de recherche.</p>
                          </div>
                        </div>
                      </td>
                    </tr>
        ...
        >
          <Modal.Header className={theme === "dark" ? "bg-dark text-light border-secondary" : ""} closeButton>
            <Modal.Title>Inviter un Formateur</Modal.Title>
          </Modal.Header>
