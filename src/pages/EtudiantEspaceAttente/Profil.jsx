...
export default function ProfilEtudiantEnAttente() {
    ...
    <WaitingAreaLayout>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <Button 
          ...
          size="lg" 
          as={Link} 
          to="/etudiant-espace-attente/edit/profil"
            ...
            <Card.Body>
              <div className="d-grid gap-2">
                ...
                <Button 
                  ...
                  as={Link} 
                  to="/etudiant-espace-attente/profil/securite"
                  className="d-flex align-items-center justify-content-center"
                >
                ...
                <Button 
                  ...
                  as={Link} 
                  to="/etudiant-espace-attente/dashboard"
                  className="d-flex align-items-center justify-content-center"
                >
