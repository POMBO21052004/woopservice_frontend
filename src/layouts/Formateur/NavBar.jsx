...
export default function AdminSystemeNavbar({ toggleSidebar }) {
  ...
  useEffect(() => {
    feather.replace();
  }, [theme, unreadMessagesCount, notificationCount]);
      ...
      <div className="navbar-right">
        ...
        <div className="position-relative me-3">
          <Button 
            variant="link" 
            as={Link}
            to="/formateur/view/notifications"
            className="navbar-action-btn"
            title={`Notifications (${notificationCount} non lues)`}
            style={{
              position: 'relative',
              border: 'none',
              background: 'transparent',
          ...
          >
            <i data-feather="bell" style={{ width: '20px', height: '20px' }} />
            {notificationCount > 0 && (
              <Badge 
                bg="danger" 
                pill 
          ...
          <Dropdown.Menu className={`dropdown-menu ${theme === "dark" ? "bg-dark border-secondary" : ""}`}>
            ...
            <div className="px-3 py-2 border-bottom d-flex align-items-center">
              ...
              <div className="flex-grow-1">
                ...
                <div className="text-muted small">{user?.email || "formateur@woopservice.com"}</div>
                <div className="text-primary small">Formateur</div>
              </div>
            </div>
            
            <Dropdown.Item 
              as={Link} 
              to="/formateur/view/profil" 
            ...
            <div className="px-3 py-2 border-bottom">
              ...
              <div className="d-flex gap-2">
                ...
                <Button 
                  ...
                  className="position-relative flex-fill"
                >
                  <i data-feather="bell" className="me-1" style={{ width: '12px', height: '12px' }} />
                  Notifications
                  {notificationCount > 0 && (
                    <Badge bg="danger" pill className="ms-1" style={{ fontSize: '0.6em' }}>
